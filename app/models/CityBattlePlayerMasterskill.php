<?php
class CityBattlePlayerMasterskill extends CityBattleModelBase{
    ...
    /**
     * 先执行CityBattlePlayerGeneral的cpData
     * 
     * @param <type> $playerId 
     * @param <type> $battleId 
	...
	public function cpData($playerId, $battleId, $data){
		...
		foreach($data as $_d){
			//获取武将
			$_general = $CityBattlePlayerGeneral->getByGeneralId($playerId, $_d['generalId']);
