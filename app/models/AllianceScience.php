<?php
class AllianceScience extends ModelBase{
	//获取所有科技
	...
	public function parseColumn($_r){
		$_r['button1_cost_id'] = parseArray($_r['button1_cost_id']);
		$_r['button2_cost_id'] = parseArray($_r['button2_cost_id']);
		$_r['button3_cost_id'] = parseArray($_r['button3_cost_id']);
